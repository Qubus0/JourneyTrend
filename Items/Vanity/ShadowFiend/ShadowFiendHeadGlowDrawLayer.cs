...
{
    public class ShadowFiendHeadGlowDrawLayer : GlowDrawLayer
    {
        public ShadowFiendHeadGlowDrawLayer() : base(
            "JourneyTrend/Items/Vanity/ShadowFiend/ShadowFiendHead_Head_Glow")
        {
        }
        ...
        {
            return drawInfo.drawPlayer.head == EquipLoader.GetEquipSlot(Mod, nameof(ShadowFiendHead), EquipType.Head)
