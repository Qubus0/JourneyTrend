...
{
    public class PoweredBag : ModItem
    {
        ...
        public override void RightClick(Player player) {
            ...
            // //guaranteed drops
            player.QuickSpawnItem(ItemType<PoweredLegs>());
            player.QuickSpawnItem(ItemType<PoweredBody>());
            player.QuickSpawnItem(ItemType<PoweredHead>());
